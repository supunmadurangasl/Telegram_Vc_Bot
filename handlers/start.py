...
@Client.on_message(filters.command(["start", "@vc_play_slbotzone_bot"]) & filters.private & ~filters.channel)
async def start(_, message: Message):
    await message.reply_text(
        text="**Hello 👋🏻 {}!**\n\nI **Can Play Music In Voice Chats of Telegram Groups.**I Have A **lot of cool feature that will amaze You!**\n\n**Click /cmdlist For More Help On My Usage ❤**".format(message.from_user.mention),
        reply_markup=InlineKeyboardMarkup(
            [[
            InlineKeyboardButton("➕ Add To Your Group ➕", url="https://t.me/vc_play_slbotzone_bot?startgroup=true")
            ],[
            InlineKeyboardButton("💬 Group", url="https://t.me/slbotzone"),
            InlineKeyboardButton("Channel 🔊", url="https://t.me/slbotzone")
            ],[
            InlineKeyboardButton("Commands 🛠", url="https://telegra.ph/supun-05-24"),
            InlineKeyboardButton("Credits ❤", url="https://telegra.ph/supun-05-24-2")
            ]]
        ),
        disable_web_page_preview=True
    )

@Client.on_message(filters.command(["start", "start@vc_play_slbotzone_bot"]) & ~filters.private & ~filters.channel)
async def gstart(_, message: Message):
      await message.reply_text(
          text="**Music Bot Is cool✅**",
          reply_markup=InlineKeyboardMarkup(
              [[
              InlineKeyboardButton(text="🎙️ Support Group 🎙️", url="https://t.me/slbotzone")
              ]]
          )
      )


@Client.on_message(filters.command(["cmdlist", "start@vc_play_slbotzone_bot"]) & filters.private & ~filters.channel)
